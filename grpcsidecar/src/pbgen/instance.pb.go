...
type K8SInstance struct {
	...
	K8Sver    string `protobuf:"bytes,1,opt,name=k8sver,proto3" json:"k8sver,omitempty"`
	K8Sdistro string `protobuf:"bytes,2,opt,name=k8sdistro,proto3" json:"k8sdistro,omitempty"`
	Context   string `protobuf:"bytes,3,opt,name=context,proto3" json:"context,omitempty"`
}

func (x *K8SInstance) Reset() {
	*x = K8SInstance{}
...
func (x *K8SInstance) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*K8SInstance) ProtoMessage() {}

func (x *K8SInstance) ProtoReflect() protoreflect.Message {
	mi := &file_instance_proto_msgTypes[0]
...
// Deprecated: Use K8SInstance.ProtoReflect.Descriptor instead.
func (*K8SInstance) Descriptor() ([]byte, []int) {
	return file_instance_proto_rawDescGZIP(), []int{0}
}

func (x *K8SInstance) GetK8Sver() string {
	if x != nil {
		return x.K8Sver
	}
	return ""
...
func (x *K8SInstance) GetK8Sdistro() string {
	if x != nil {
		return x.K8Sdistro
	}
	return ""
...
func (x *K8SInstance) GetContext() string {
	if x != nil {
		return x.Context
	}
	return ""
...
var file_instance_proto_rawDesc = []byte{
	...
	0x12, 0x07, 0x61, 0x6c, 0x65, 0x72, 0x74, 0x65, 0x72, 0x22, 0x5d, 0x0a, 0x0b, 0x4b, 0x38, 0x73,
	0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x6b, 0x38, 0x73, 0x76,
	0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6b, 0x38, 0x73, 0x76, 0x65, 0x72,
	0x12, 0x1c, 0x0a, 0x09, 0x6b, 0x38, 0x73, 0x64, 0x69, 0x73, 0x74, 0x72, 0x6f, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x09, 0x6b, 0x38, 0x73, 0x64, 0x69, 0x73, 0x74, 0x72, 0x6f, 0x12, 0x18,
	0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x2f, 0x70, 0x62,
...
var file_instance_proto_goTypes = []interface{}{
	(*K8SInstance)(nil), // 0: alerter.K8sInstance
}
